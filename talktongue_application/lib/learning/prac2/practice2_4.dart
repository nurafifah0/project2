...
import 'package:talktongue_application/learning/prac2/practice2_3.dart';
import 'package:talktongue_application/models/post.dart';
import 'package:talktongue_application/models/user.dart';

import 'practice2_5.dart';

class Practice2sub4 extends StatefulWidget {
  const Practice2sub4({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice2sub4> createState() => _Practice2sub4State();
}

class _Practice2sub4State extends State<Practice2sub4> {
  ...
  void previousPage() {
    ...
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice2sub3(userdata: widget.userdata, post: widget.post)));
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice2sub5(userdata: widget.userdata, post: widget.post)));
  }
