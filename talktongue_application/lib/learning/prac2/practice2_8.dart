...
import 'package:talktongue_application/learning/prac2/practice2_7.dart';
import 'package:talktongue_application/models/post.dart';
import 'package:talktongue_application/models/user.dart';

import 'practice2_9.dart';

class Practice2sub8 extends StatefulWidget {
  const Practice2sub8({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice2sub8> createState() => _Practice2sub8State();
}

class _Practice2sub8State extends State<Practice2sub8> {
