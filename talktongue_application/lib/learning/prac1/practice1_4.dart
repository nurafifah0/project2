...
import 'practice1_5.dart';

class Practice1sub4 extends StatefulWidget {
  const Practice1sub4({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice1sub4> createState() => _Practice1sub4State();
}

class _Practice1sub4State extends State<Practice1sub4> {
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice1sub5(userdata: widget.userdata, post: widget.post)));
  }
