...
import 'practice1_7.dart';

class Practice1sub6 extends StatefulWidget {
  const Practice1sub6({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice1sub6> createState() => _Practice1sub6State();
}

class _Practice1sub6State extends State<Practice1sub6> {
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice1sub7(userdata: widget.userdata, post: widget.post)));
  }
