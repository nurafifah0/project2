...
import 'practice1_8.dart';

class Practice1sub7 extends StatefulWidget {
  const Practice1sub7({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice1sub7> createState() => _Practice1sub7State();
}

class _Practice1sub7State extends State<Practice1sub7> {
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice1sub8(userdata: widget.userdata, post: widget.post)));
  }
