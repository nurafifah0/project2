...
import 'practice1_4.dart';

class Practice1sub3 extends StatefulWidget {
  const Practice1sub3({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice1sub3> createState() => _Practice1sub3State();
}

class _Practice1sub3State extends State<Practice1sub3> {
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice1sub4(userdata: widget.userdata, post: widget.post)));
  }
