...
import 'practice1_3.dart';

class Practice1sub2 extends StatefulWidget {
  const Practice1sub2({super.key, required this.userdata, required this.post});
  final User userdata;
  final Post post;

  @override
  State<Practice1sub2> createState() => _Practice1sub2State();
}

class _Practice1sub2State extends State<Practice1sub2> {
  ...
  void nextPage() {
    Navigator.pushReplacement(
        ...
        MaterialPageRoute(
            builder: (content) =>
                Practice1sub3(userdata: widget.userdata, post: widget.post)));
  }
